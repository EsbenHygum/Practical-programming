...
delta_x = rf_analytic(rosen, x0, df_rosen, 1e-6)
print("The analytic function yields a minimum at [%.2f;%.2f] with %d steps" %(delta_x[0], delta_x[1], calls))
calls = 0
delta_x = rf_numeric(rosen, x0, 1e-6, 1e-6)
print("The numeric function yields a minimum at [%.2f;%.2f] with %d steps" %(delta_x[0], delta_x[1], calls))
calls = 0
...
delta_x = rf_analytic(himmelblau, x0, df_himmelblau, 1e-6)
print("The analytic function yields a minimum at [%.2f;%.2f] with %d steps" %(delta_x[0], delta_x[1], calls))
calls = 0
delta_x = rf_numeric(himmelblau, x0, 1e-6, 1e-6)
print("The numeric function yields a minimum at [%.2f;%.2f] with %d steps" %(delta_x[0], delta_x[1], calls))
calls = 0
